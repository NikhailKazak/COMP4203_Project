...
if __name__ == "__main__":
    ...
    while promptInput!="5":
        ...
        if(promptInput=="1"):
            ...
            print("\nWhich address do you wish to gather metrics for? Please enter the full address and device ( e.g., 00:04:4B:F9:01:DB :: NVIDIA SHIELD Remote )\n")
